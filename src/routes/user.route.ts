...
import { getMeController, loginController, registerController, updateMeController } from '~/controllers/user.controller'
...
usersRouter.post('/update-me', accessTokenValidator, wrapRequestHandler(updateMeController))
